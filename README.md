...
# Overview
# ------------------------------------------------------------
# GrabMySeat is a backend system inspired by real-world ticket
# booking platforms like BookMyShow.
#
...
#
# This project demonstrates production-grade backend design
# and is suitable as a 5+ years experience portfolio project.
#
# ------------------------------------------------------------
# Core Features
# ------------------------------------------------------------
